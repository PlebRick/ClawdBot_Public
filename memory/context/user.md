...
- Common language over academic. "Self-help" not "self-actualization."
- Generous toward the church — "many get wrong" not "the church gets wrong."
...
- **Training-optimized voice:** `memory/training/voice-profile.md` (7K, load when writing as Rick)
- **Theological positions:** `memory/context/ricks-theological-framework.md` (authoritative, Rick's own words)
- **Theological positions from sermons:** `memory/context/theological-positions.md`
- **Biography:** `memory/context/ricks-bio.md`
- **ArnoldOS domain mapping:** `memory/context/arnoldos-integration-prd.md`
- **Sermon archive:** `memory/training/sermon-archive/INDEX.md` (17 sermons)
- **AI calibration guide:** `memory/training/ai-voice-calibration.md`
- **Recurring themes:** `memory/context/recurring-themes.md`
