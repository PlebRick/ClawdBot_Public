...
1. **Essentials** — non-negotiable, define the faith
2. **Convictions** — firmly held, will teach, but won't divide over
...
- **Unlimited atonement** — Christ died for all, not only the elect
- **Regeneration AFTER conviction and repentance** — unlike Grudem who places regeneration before faith. Rick's order: prevenient grace → conviction → repentance → faith → regeneration
- **Corporate election** — tends to see election in the corporate sense (God elects a people, individuals enter by faith)
- **Hebrews warnings taken seriously** — the possibility of apostasy is real
  - NOT: "lose salvation every time you mess up"
...
- **Would not die on that hill** — this is in the "Convictions" or "Opinions" bucket, not "Essentials"
- **N.T. Wright's eschatology** appreciated:
  - Resurrection of all things (new creation, not escape)
...
|-----------|----------------|-----------------|
| N.T. Wright | Covenant faithfulness, kingdom now/not-yet, resurrection of all things | Some Wright positions Rick holds loosely |
| John Stott | Expository method, Cross of Christ, balanced evangelicalism | — |
| William Lane Craig | Molinism, philosophical apologetics | — |
| Sam Storms | Amillennialism, continuationist pneumatology | — |
| Charles Finney | Preaching style, illustrations, revival urgency | Entire sanctification theology |
| Wayne Grudem | Systematic theology reference | Order of salvation (Grudem: regeneration before faith) |
| Mark Driscoll | Preaching style, directness, cultural engagement | — |
| Tim Keller | Gospel-centered framework, cultural apologetics | — |
| Martyn Lloyd-Jones | Expository depth, Spirit-emphasis, revival theology | — |
| J.I. Packer | Knowing God framework, theological precision | — |
| R.T. Kendall | Pastoral wisdom, total forgiveness teaching | — |
| Gordon Fee | Pauline scholarship, pneumatology | — |
| A.W. Tozer | Pursuit of God, transcendence, devotional depth | — |
| Francis Chan | Urgency, radical obedience, practical faith | — |
...
2. **Never use "once saved always saved" language** — Rick takes Hebrews warnings seriously
3. **Frame election corporately** — "God chose a people" not "God chose individuals before they existed"
4. **Regeneration follows repentance** — never imply people are regenerated before they believe
5. **Atonement is unlimited** — Christ died for all
6. **Hold eschatology loosely** — amillennial lean but not dogmatic
7. **Spirit-emphasis always** — but grounded, not extreme
8. **Unity over division** — Romans 14 principle. Don't elevate opinions to essentials.
9. **Christ at the center** — always. Everything points to Jesus.
10. **Molinism for sovereignty/freedom tension** — middle knowledge, not determinism or open theism
