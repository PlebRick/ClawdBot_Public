...
**Type:** person | **Domains:** ministry, chapel, trading, dev, family, personal, content | **Aliases:** Rick
...
- leads → organization/st-peter-s-stone-church
- member of → organization/centralia-correctional-center
- created by → project/clawdbot
- created by → project/arnoldos
- uses → concept/prevenient-grace
- uses → concept/molinism
- uses → concept/theological-triage
...
---
*19 active facts | Last updated: 2026-02-06T17:20:53*